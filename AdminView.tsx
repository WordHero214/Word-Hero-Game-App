        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-6 shadow-lg shadow-purple-200">
              <div className="text-purple-100 text-sm font-bold mb-2">Total Users</div>
            ...
            <div className="bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl p-6 shadow-lg shadow-teal-200">
              <div className="text-teal-100 text-sm font-bold mb-2">Teachers</div>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 shadow-lg shadow-blue-200">
              <div className="text-blue-100 text-sm font-bold mb-2">Students</div>
              <div className="text-white text-3xl font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 shadow-lg shadow-blue-200">
              <div className="flex items-center justify-between mb-3">
                <div className="text-blue-100 text-sm font-bold">Total Users</div>
            ...
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 shadow-lg shadow-green-200">
              <div className="flex items-center justify-between mb-3">
                <div className="text-green-100 text-sm font-bold">Games Played</div>
                <div className="text-3xl">🎮</div>
              </div>
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl p-6 shadow-lg shadow-yellow-200">
              <div className="flex items-center justify-between mb-3">
                <div className="text-yellow-100 text-sm font-bold">Total Sparkies</div>
                <div className="text-3xl">✨</div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-6 shadow-lg shadow-purple-200">
              <div className="flex items-center justify-between mb-3">
                <div className="text-purple-100 text-sm font-bold">Certificates</div>
                <div className="text-3xl">🏆</div>
              </div>
