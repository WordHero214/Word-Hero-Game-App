...
const ProfileView: React.FC<ProfileViewProps> = ({ user, onLogout, onNavigate }) => {
  ...
  const generateClassReport = async () => {
    try {
      ...
      doc.text('Generated by Mastering Minds - A Spelling Journey and Creative Challenges for Elementary Students', 105, 285, { align: 'center' });
  ...
  const downloadCertificate = (cert: Certificate) => {
    ...
    doc.setFontSize(12);
    doc.text('Mastering Minds: A Spelling Journey and Creative Challenges for Elementary Students', 300, 115, { align: 'center' });
        ...
        <div className="relative z-10">
          ...
          {user.role === UserRole.TEACHER && (
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/5 mb-8">
              <div>
                <span className="text-[#00c2a0] text-2xl block mb-1">👥</span>
              ...
              <div>
                <span className="text-[#f39c12] text-2xl block mb-1">📚</span>
                ...
                {user.certificates.map(cert => (
                  <div key={cert.id} className="bg-[#162031] p-6 rounded-[2rem] border border-[#f39c12]/20 flex flex-col shadow-xl animate-in zoom-in duration-300">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-14 h-14 bg-[#f39c12]/10 rounded-2xl flex items-center justify-center text-3xl">📜</div>
                      <div>
