...
export const BILINGUAL_WORDS: Word[] = [
  ...
  { 
    ...
    scenario: 'This beautiful insect flies from flower to flower. Can you spell it?',
    hintFil: 'Isang makulay na insekto na may pakpak',
    scenarioFil: 'Ang magandang insekto na ito ay lumilipad mula bulaklak hanggang bulaklak. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h22', 
    term: 'RAINBOW', 
    ...
    gradeLevels: ['1', '2'],
    hint: 'Colorful arc in the sky after rain',
    scenario: 'This appears in the sky with many colors after it rains. Can you spell it?',
    hintFil: 'Makulay na arko sa langit pagkatapos ng ulan',
    scenarioFil: 'Ito ay lumilitaw sa langit na may maraming kulay pagkatapos ng ulan. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h23', 
    term: 'ELEPHANT', 
    ...
    category: 'Animals', 
    gradeLevels: ['1', '2'],
    hint: 'Large animal with a long trunk',
    scenario: 'This huge animal has a long nose called a trunk. Can you spell it?',
    hintFil: 'Malaking hayop na may mahabang nguso',
    scenarioFil: 'Ang malaking hayop na ito ay may mahabang ilong na tinatawag na trunk. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h24', 
    term: 'BIRTHDAY', 
    ...
    scenario: 'We celebrate this special day once a year with cake and candles. Can you spell it?',
    hintFil: 'Ang araw na ipinanganak ka',
    scenarioFil: 'Ipinagdiriwang natin ang espesyal na araw na ito minsan sa isang taon na may cake at kandila. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h25', 
    term: 'PLAYGROUND', 
    ...
    scenario: 'This is where you go to play on swings and slides. Can you spell it?',
    hintFil: 'Lugar kung saan naglalaro ang mga bata',
    scenarioFil: 'Dito ka pumupunta para maglaro sa duyan at slide. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h26', 
    term: 'SUNSHINE', 
    ...
    scenario: 'This bright light comes from the sun and makes us warm. Can you spell it?',
    hintFil: 'Liwanag mula sa araw',
    scenarioFil: 'Ang maliwanag na liwanag na ito ay nanggagaling sa araw at nagpapainit sa atin. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h27', 
    term: 'CHOCOLATE', 
    ...
    scenario: 'This sweet brown food melts in your mouth. Can you spell it?',
    hintFil: 'Matamis na kayumangging pagkain',
    scenarioFil: 'Ang matamis na kayumangging pagkain na ito ay natutunaw sa iyong bibig. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h28', 
    term: 'DINOSAUR', 
    ...
    category: 'Animals', 
    gradeLevels: ['1', '2'],
    hint: 'Giant reptile from long ago',
    scenario: 'This huge animal lived millions of years ago. Can you spell it?',
    hintFil: 'Higanteng reptilya mula sa nakaraan',
    scenarioFil: 'Ang malaking hayop na ito ay nabuhay milyun-milyong taon na ang nakakaraan. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h29', 
    term: 'UMBRELLA', 
    ...
    scenario: 'You open this to stay dry when it rains. Can you spell it?',
    hintFil: 'Nagpapatuyo sa iyo sa ulan',
    scenarioFil: 'Binubuksan mo ito para manatiling tuyo kapag umuulan. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h30', 
    term: 'SANDWICH', 
    ...
    scenario: 'This food has meat or cheese between two pieces of bread. Can you spell it?',
    hintFil: 'Pagkain sa pagitan ng dalawang piraso ng tinapay',
    scenarioFil: 'Ang pagkain na ito ay may karne o keso sa pagitan ng dalawang piraso ng tinapay. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h31', 
    term: 'BACKPACK', 
    ...
    category: 'Objects', 
    gradeLevels: ['1', '2'],
    hint: 'Bag you carry on your back',
    scenario: 'You carry your books to school in this. Can you spell it?',
    hintFil: 'Bag na dala mo sa likod',
    scenarioFil: 'Dala mo ang iyong mga libro sa paaralan sa loob nito. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h32', 
    term: 'FOOTBALL', 
    ...
    category: 'Sports', 
    gradeLevels: ['1', '2'],
    hint: 'A sport played with a round ball',
    scenario: 'You kick this ball to score goals. Can you spell it?',
    hintFil: 'Isang laro na nilalaro gamit ang bilog na bola',
    scenarioFil: 'Sinisipa mo ang bola na ito para makagol. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h33', 
    term: 'HOMEWORK', 
    ...
    category: 'School', 
    gradeLevels: ['1', '2'],
    hint: 'School work done at home',
    scenario: 'Your teacher gives you this to do after school. Can you spell it?',
    hintFil: 'Gawaing paaralan na ginagawa sa bahay',
    scenarioFil: 'Binibigay ito ng iyong guro para gawin pagkatapos ng klase. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h34', 
    term: 'BEDROOM', 
    ...
    category: 'Places', 
    gradeLevels: ['1', '2'],
    hint: 'Room where you sleep',
    scenario: 'This is the room in your house where your bed is. Can you spell it?',
    hintFil: 'Silid kung saan ka natutulog',
    scenarioFil: 'Ito ang silid sa iyong bahay kung saan naroon ang iyong kama. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h35', 
    term: 'POPCORN', 
    ...
    category: 'Food', 
    gradeLevels: ['1', '2'],
    hint: 'Snack that pops when heated',
    scenario: 'This crunchy snack is popular at movies. Can you spell it?',
    hintFil: 'Meryenda na pumipitik kapag pinainit',
    scenarioFil: 'Ang malutong na meryenda na ito ay popular sa sine. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h36', 
    term: 'STARFISH', 
    ...
    category: 'Animals', 
    gradeLevels: ['1', '2'],
    hint: 'Sea animal shaped like a star',
    scenario: 'This ocean animal has five arms and looks like a star. Can you spell it?',
    hintFil: 'Hayop sa dagat na hugis bituin',
    scenarioFil: 'Ang hayop sa dagat na ito ay may limang braso at mukhang bituin. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h37', 
    term: 'AIRPLANE', 
    ...
    scenario: 'This machine flies high in the sky with passengers. Can you spell it?',
    hintFil: 'Lumipad na sasakyan na may pakpak',
    scenarioFil: 'Ang makina na ito ay lumilipad sa mataas na langit na may mga pasahero. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h38', 
    term: 'SEASHELL', 
    ...
    category: 'Nature', 
    gradeLevels: ['1', '2'],
    hint: 'Hard shell found at the beach',
    scenario: 'You can find this pretty shell on the beach. Can you spell it?',
    hintFil: 'Matigas na shell na makikita sa dalampasigan',
    scenarioFil: 'Makikita mo ang magandang shell na ito sa dalampasigan. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h39', 
    term: 'SNOWMAN', 
    ...
    category: 'Winter', 
    gradeLevels: ['1', '2'],
    hint: 'Figure made of snow',
    scenario: 'You build this person out of snow with a carrot nose. Can you spell it?',
    hintFil: 'Pigura na gawa sa niyebe',
    scenarioFil: 'Ginagawa mo ang taong ito mula sa niyebe na may ilong na karot. Marunong ka bang magbaybay nito?'
  },
  { 
    id: 'h40', 
    term: 'SUNFLOWER', 
    ...
    scenario: 'This big yellow flower turns to face the sun. Can you spell it?',
    hintFil: 'Matangkad na dilaw na bulaklak na sumusunod sa araw',
    scenarioFil: 'Ang malaking dilaw na bulaklak na ito ay lumiliko para harapin ang araw. Marunong ka bang magbaybay nito?'
  }
];
